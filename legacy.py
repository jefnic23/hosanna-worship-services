...
ppt.add_call_and_response('', lit.lord_be_with_you, anchor='middle')
...
ppt.add_call_and_response('Dialogue', lit.dialogue, anchor='middle')
ppt.add_congregation_text('Holy, holy, holy', lit.hosanna)
ppt.add_call_and_response('Thanksgiving', lit.communion_dialogue)
...
ppt.add_call_and_response('Blessing', lit.blessing)
ppt.add_hymn()
ppt.add_call_and_response('Dismissal', lit.dismissal, anchor='middle')
ppt.add_image()
ppt.save()

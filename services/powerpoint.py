...
class PowerPoint:
    ...
    def add_intercessions(self, call: str, response: str) -> None:
    ...
    def _add_header(slide: Slide, header_text: str) -> None:
        ...
        PowerPoint._add_run(
            paragraph, header_text, size=12, bold=True, color=(66, 133, 244)
        )
    ...
    @staticmethod
    def check_size(
        line: str, draw: ImageDraw.ImageDraw, font: FreeTypeFont
    ) -> dict[str, int]:
